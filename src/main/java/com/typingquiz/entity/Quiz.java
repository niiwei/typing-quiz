...
public class Quiz {
    ...
    private QuizType quizType = QuizType.TYPING;

    /**
     * 关联的分组列表
     */
    @ManyToMany(mappedBy = "quizzes")
    private List<QuizGroup> groups = new ArrayList<>();
    ...
    public List<QuizGroup> getGroups() {
        return groups;
    }

    public void setGroups(List<QuizGroup> groups) {
        this.groups = groups;
    }
