...
| 票 | 交付 | 依赖 |
|---|---|---|
| [01](issues/01-test-baseline.md) | 隔离验证入口与旧题基线 | 无 |
| [02](issues/02-whitespace.md) | 真正忽略内部空白 | 01 |
| [03](issues/03-inline-context.md) | 免输入正文完整编辑作答闭环 | 02 |
| [04](issues/04-partial-answer.md) | 多要点逐段作答及结算复习闭环 | 03 |
